...
This programm uses the `aes.js` programm, which
were made by Josh Davis (http://www.josh-davis.org)
and Mark Percival (http://mpercival.com) from the
original project called `SlowAES` from
http://code.google.com/p/slowaes/
licensed under Apache License Version 2.0 by
`aes.js` programm creators.
Also thanks to Laurent Haan which written the
original proramm `aes.js` but in C
http://www.progressive-coding.com
|===============================================|
|       Use this programm as you want !         |
|===============================================|
"""


# slowAES function need to be specified because JavaScript know what is it but not Js2Py
slowAES = """
/*
